...
local help = label({ AnchorPoint = Vector2.new(0, 1), Position = UDim2.new(0, 14, 1, -14), Size = UDim2.new(0, 520, 0, 90), Font = FONT2,
	...
	Text = "Clic izq: golpe (mové el mouse para elegir la dirección) · Rueda arriba: estocada · Rueda abajo: golpe de arriba\nClic der: parry (con escudo: mantener) · Q: fintar · F: patada · G: soltar o levantar el arma · Shift: correr · V: cámara · Alt: vista libre · [ ]: FOV · Tab: tabla · F3: modo desarrollador · F4: cámara lenta · M: forja y ajustes · H: ocultar ayuda" })
...
UserInputService.InputBegan:Connect(function(input, processed)
	...
	elseif input.KeyCode == Enum.KeyCode.LeftAlt then
		-- Alt enciende y apaga la vista libre: la cámara gira alrededor tuyo sin mover al caballero
...
RunService.RenderStepped:Connect(function(dt)
	...
	stateText.Text = freeCam.on and "VISTA LIBRE · Alt para volver"
